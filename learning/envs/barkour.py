...
class BarkourEnv(PipelineEnv):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        path = _HERE / "assets" / "google_barkour_vb"
        # path = BARKOUR_ROOT_PATH / scene_file
        sys = mjcf.load((path / scene_file).as_posix())
        ...
        self._init_q = jp.array(sys.mj_model.keyframe("standing").qpos)
        # self._init_q = jp.array(sys.mj_model.keyframe("home").qpos)
        self._default_pose = sys.mj_model.keyframe("standing").qpos[7:]
    ...
    def get_demo_video(
        ...
        frames = np.array(eval_env.render(rollout[::render_every], camera="track"))
