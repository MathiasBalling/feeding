...
import wandb
from learning.envs.panda_bring_to_target import PandaBringToTarget
from utils.args import Args
from utils.learning import create_data_directory


@dataclass(frozen=True)
class PandaBringToTargetArgs(Args):
    """
...
args = tyro.cli(PandaBringToTargetArgs, description=__doc__)
...
envs.register_environment(args.env_name, PandaBringToTarget)
env: PandaBringToTarget = envs.get_environment(args.env_name)
