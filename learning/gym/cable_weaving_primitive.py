...
import wandb
from learning.envs.cable_weaving_primitive import CableWeavingPrimitive
from utils.args import Args
from utils.learning import generate_demo_video


@dataclass(frozen=True)
class CableWeavingPrimitiveArgs(Args):
    """
...
args = tyro.cli(CableWeavingPrimitiveArgs, description=__doc__)
...
envs.register_environment(args.env_name, CableWeavingPrimitive)
