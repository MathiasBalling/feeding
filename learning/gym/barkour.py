...
args = tyro.cli(BarkourArgs, description=__doc__)
...
env: BarkourEnv = envs.get_environment(args.env_name)
...
make_inference_fn, params, metrics = train_fn(
    environment=env, progress_fn=evaluation_callback, eval_env=eval_env
)
...
# the eval_env is here parsed due to domain_randomization being applied in the training process
