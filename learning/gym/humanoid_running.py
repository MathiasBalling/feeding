...
class HumanoidRunningArgs(Args):
    """
...
args = tyro.cli(HumanoidRunningArgs, description=__doc__)
...
envs.register_environment(args.env_name, HumanoidRunning)
env: HumanoidRunning = envs.get_environment(args.env_name)
