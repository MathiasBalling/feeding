...
from scripts.config import _DEFAULT_GRIPPER_FORCE, _DEFAULT_GRIPPER_SPEED, _MAX_GRIPPER_POS, _MAX_GRIPPER_SPEED
...
class RobotiqGripper:
    ...
    def move(self, position: int, speed: int = _DEFAULT_GRIPPER_SPEED, force: int = _DEFAULT_GRIPPER_FORCE) -> Tuple[bool, int]:
    ...
    def move_and_wait_for_pos(self, position: int, speed: int = _DEFAULT_GRIPPER_SPEED, force: int = _DEFAULT_GRIPPER_FORCE, pct: bool = True) -> Tuple[int, ObjectStatus]:  # noqa
        ...
        if pct:
            position = int(position * _MAX_GRIPPER_POS)
